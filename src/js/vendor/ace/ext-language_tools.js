    ...
    var AcePopup = /** @class */ (function () {
      function AcePopup (parentNode) {
        ...
        popup.renderer.$textLayer.element.setAttribute(
          ...
          nls('autocomplete.popup.aria-roledescription', 'Autocomplete suggestions')
        )
        popup.renderer.$textLayer.element.setAttribute(
          'aria-label',
...
ace.define('ace/autocomplete/inline_screenreader', ['require', 'exports', 'module'], function (
  require,
  exports,
  module
) {
  ...
  var AceInlineScreenReader = /** @class */ (function () {
    ...
    AceInlineScreenReader.prototype.setScreenReaderContent = function (content) {
      if (
        ...
        /**@type{import("../autocomplete").Autocomplete}*/ (this.editor.completer).popup
      ) {
...
ace.define(
  ...
  ['require', 'exports', 'module', 'ace/snippets', 'ace/autocomplete/inline_screenreader'],
  function (require, exports, module) {
    'use strict'
    ...
    var Autocomplete = /** @class */ (function () {
      ...
      Autocomplete.prototype.showDocTooltip = function (item) {
        ...
        this.tooltipNode.className =
          'ace_tooltip ace_doc-tooltip ' + (theme.isDark ? 'ace_dark ' : '') + (theme.cssClass || '')
...
ace.define('ace/autocomplete/text_completer', ['require', 'exports', 'module', 'ace/range'], function (
  require,
  exports,
  module
) {

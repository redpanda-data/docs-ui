...
!(function (e) {
  ...
  (e.onerror = function (e, t, n, r, i) {
    postMessage({
      type: 'error',
      data: { message: e, data: i && i.data, file: t, line: n, col: r, stack: i && i.stack },
    })
  }),
...
define('ace/anchor', [], function (e, t, n) {
  ...
  function u (e, t, n) {
    ...
    var i = (r ? 1 : -1) * (e.end.row - e.start.row)
    var s = (r ? 1 : -1) * (e.end.column - e.start.column)
    var u = e.start
    var a = r ? u : e.end
    return o(t, u, n)
  ...
  var s = (function () {
    function e (e, t, n) {
      ...
      this.attach(e),
      typeof t !== 'number' ? this.setPosition(t.row, t.column) : this.setPosition(t, n)
    }
    return (
      ...
      (e.prototype.onChange = function (e) {
        ...
        var t = u(e, { row: this.row, column: this.column }, this.$insertRight)
...
define('ace/document', [], function (e, t, n) {
  'use strict'
  var r = e('./lib/oop')
  var i = e('./apply_delta').applyDelta
  var s = e('./lib/event_emitter').EventEmitter
  var o = e('./range').Range
  var u = e('./anchor').Anchor
  var a = (function () {
    function e (e) {
      ;(this.$lines = ['']),
      e.length === 0
    ...
    return (
      ...
      (e.prototype.insertInLine = function (e, t) {
        ...
        var r = this.pos(e.row, e.column + t.length)
      ...
      (e.prototype.insertMergedLines = function (e, t) {
        var n = this.clippedPos(e.row, e.column)
        var r = { row: n.row + t.length - 1, column: (t.length == 1 ? n.column : 0) + t[t.length - 1].length }
      ...
      (e.prototype.remove = function (e) {
        ...
        var n = this.clippedPos(e.end.row, e.end.column)
        return (
          this.applyDelta({
            start: t,
            end: n,
      ...
      (e.prototype.removeFullLines = function (e, t) {
        ...
        var r = t < this.getLength() - 1
        var i = n ? e - 1 : e
        var s = n ? this.getLine(i).length : 0
        var u = r ? t + 1 : t
        var a = r ? 0 : this.getLine(u).length
        var f = new o(i, s, u, a)
        var l = this.$lines.slice(e, t + 1)
...
define('ace/lib/deep_copy', [], function (e, t, n) {
...
define('ace/worker/mirror', [], function (e, t, n) {
  ...
  var i = e('../lib/lang')
  var s = (t.Mirror = function (e) {
    this.sender = e
    var t = (this.doc = new r(''))
    var n = (this.deferredUpdate = i.delayedCall(this.onUpdate.bind(this)))
    var s = this
      ...
      if (r[0].start) t.applyDeltas(r)
        ...
        for (var i = 0; i < r.length; i += 2) {
          ...
          if ((o.action == 'insert' ? o.start : o.end).row >= t.$lines.length) {
            throw ((u = new Error('Invalid delta')),
            (u.data = { path: s.$path, linesLength: t.$lines.length, start: o.start, end: o.end }),
            u)
          }
          t.applyDelta(o, !0)
        }
...
define('ace/mode/yaml/yaml-lint', [], function (e, t, n) {
  function i (t, n, i) {
    typeof t === 'function' && ((i = t), (n = ['require', 'exports', 'module']), (t = r.module.id)),
  ...
  (function (e) {
    ...
    return (function () {
      function t (n, r, i) {
        ...
        for (var o = typeof e === 'function' && e, u = 0; u < i.length; u++) s(i[u])
        return s
      }
      return t
    })()(
      {
        ...
        2: [
          function (e, t, n) {
            ...
            var r = e('fs')
            var i = e('lodash.merge')
            var s = e('js-yaml')
            var o = { schema: 'DEFAULT_SAFE_SCHEMA' }
            t.exports = { lint: u }
          },
        ...
        5: [
          function (e, t, n) {
            ...
            function o (e, t) {
              ...
              if (t) {
                s = Object.keys(t)
                for (n = 0, r = s.length; n < r; n += 1) (i = s[n]), (e[i] = t[i])
              }
              return e
            }
            function u (e, t) {
        ...
        6: [
          function (e, t, n) {
            ...
            function R (e) {
              return (
                q(e) && e !== 65279 && e !== b && e !== N && e !== C && e !== L && e !== O && e !== E && e !== d
              )
            }
            function U (e) {
              return (
            ...
            function K (e, t, n, r, i) {
              ...
              var f = r !== -1
              var c = -1
              var h = U(e.charCodeAt(0)) && !I(e.charCodeAt(e.length - 1))
              if (t) {
                ...
                for (s = 0; s < e.length; s++) {
                  o = e.charCodeAt(s)
                  if (o === l) (u = !0), f && ((a = a || (s - c - 1 > r && e[c + 1] !== ' ')), (c = s))
            ...
            function Q (e, t, n, r) {
              e.dump = (function () {
                ...
                var o = e.lineWidth === -1 ? -1 : Math.max(Math.min(e.lineWidth, 40), e.lineWidth - s)
                var u = r || (e.flowLevel > -1 && n >= e.flowLevel)
            ...
            function st (e, t, n, r) {
              ...
              for (a = 0, f = u.length; a < f; a += 1) {
                ...
                p && (e.dump && l === e.dump.charCodeAt(0) ? (d += '?') : (d += '? ')),
                (d += e.dump),
                p && (d += j(e, t))
              ...
              if (c && e.usedDuplicates[l]) e.dump = '*ref_' + l
                ...
                if (a === '[object Object]') {
                  r && Object.keys(e.dump).length !== 0
                    ? (st(e, t, e.dump, s), c && (e.dump = '&ref_' + l + e.dump))
                    : (it(e, t, e.dump), c && (e.dump = '&ref_' + l + ' ' + e.dump))
                } else if (a === '[object Array]') {
                  var h = e.noArrayIndent && t > 0 ? t - 1 : t
                  r && e.dump.length !== 0
                    ? (rt(e, h, e.dump, s), c && (e.dump = '&ref_' + l + e.dump))
                    : (nt(e, h, e.dump), c && (e.dump = '&ref_' + l + ' ' + e.dump))
                } else {
                  if (a !== '[object String]') {
            ...
            function at (e, t) {
              ...
              var s
              ft(e, n, r)
              for (i = 0, s = r.length; i < s; i += 1) t.duplicates.push(n[r[i]])
            ...
            function ft (e, t, n) {
              ...
              if (e !== null && typeof e === 'object') {
                ...
                if (i !== -1) n.indexOf(i) === -1 && n.push(i)
                  ...
                  t.push(e)
                  if (Array.isArray(e)) for (i = 0, s = e.length; i < s; i += 1) ft(e[i], t, n)
                  else {
                    r = Object.keys(e)
                    for (i = 0, s = r.length; i < s; i += 1) ft(e[r[i]], t, n)
                  }
                }
              }
            }
            ...
            var r = e('./common')
            var i = e('./exception')
            var s = e('./schema/default_full')
            var o = e('./schema/default_safe')
        ...
        8: [
          function (e, t, n) {
            ...
            function I (e, t, n, i) {
              var s, o, u, f
              r.isObject(n) || H(e, 'cannot merge mappings; the provided source object is unacceptable'),
              (s = Object.keys(n))
              for (u = 0, f = s.length; u < f; u += 1) (o = s[u]), a.call(t, o) || ((t[o] = n[o]), (i[o] = !0))
            }
            function q (e, t, n, r, i, s, o, u) {
              var f, l
                  ;(i = String(i)), t === null && (t = {})
              if (r === 'tag:yaml.org,2002:merge') {
                if (Array.isArray(s)) for (f = 0, l = s.length; f < l; f += 1) I(e, t, s[f], n)
                else I(e, t, s, n)
              } else {
                !e.json &&
                      !a.call(n, i) &&
                      a.call(t, i) &&
                      ((e.line = o || e.line), (e.position = u || e.position), H(e, 'duplicated mapping key')),
                (t[i] = s),
                delete n[i]
              }
              return t
            ...
            function U (e, t, n) {
              var r = 0
              var i = e.input.charCodeAt(e.position)
              while (i !== 0) {
                ...
                while (i === 32) e.lineIndent++, (i = e.input.charCodeAt(++e.position))
              }
            ...
            function X (e, t, n) {
              ...
              while (p !== 0) {
                ...
                u && (F(e, s, o, !1), W(e, e.line - a), (s = o = e.position), (u = !1)),
                S(p) || (o = e.position + 1),
                (p = e.input.charCodeAt(++e.position))
              }
            ...
            function V (e, t) {
              ...
              while ((n = e.input.charCodeAt(e.position)) !== 0) {
                if (n === 39) {
                  ...
                  E(n)
                    ? (F(e, r, i, !0), W(e, U(e, !1, t)), (r = i = e.position))
                    : e.position === e.lineStart && z(e)
                      ? H(e, 'unexpected end of the document within a single quoted scalar')
            ...
            function $ (e, t) {
              ...
              while ((u = e.input.charCodeAt(e.position)) !== 0) {
                ...
                if (u === 92) {
                  ...
                  if (E(u)) U(e, !1, t)
                  else if (u < 256 && O[u]) (e.result += M[u]), e.position++
                  else if ((o = C(u)) > 0) {
                    ;(i = o), (s = 0)
                    for (; i > 0; i--) {
                      (u = e.input.charCodeAt(++e.position)),
                  ...
                  E(u)
                    ? (F(e, n, r, !0), W(e, U(e, !1, t)), (n = r = e.position))
                    : e.position === e.lineStart && z(e)
                      ? H(e, 'unexpected end of the document within a double quoted scalar')
            ...
            function J (e, t) {
              ...
              while (g !== 0) {
                ...
                (l = c = !1),
                g === 63 &&
                        ((u = e.input.charCodeAt(e.position + 1)), x(u) && ((l = c = !0), e.position++, U(e, !0, t))),
                (r = e.line),
                tt(e, t, f, !1, !0),
                (v = e.tag),
                (d = e.result),
                ...
                (c || e.line === r) &&
                        ...
                        tt(e, t, f, !1, !0),
                        (m = e.result)),
                h ? q(e, s, p, v, d, m) : l ? s.push(q(e, null, p, v, d, m)) : s.push(d),
                U(e, !0, t),
                (g = e.input.charCodeAt(e.position)),
            ...
            function K (e, t) {
              ...
              while (h !== 0) {
                ...
                while ((!u || e.lineIndent < a) && h === 32) e.lineIndent++, (h = e.input.charCodeAt(++e.position))
                ...
                (f = 0),
                (n = e.position)
                while (!E(h) && h !== 0) h = e.input.charCodeAt(++e.position)
                F(e, n, e.position, !1)
              }
              return !0
            }
            function Q (e, t) {
              ...
              while (a !== 0) {
                ...
                if ((e.line === n || e.lineIndent > t) && a !== 0) H(e, 'bad indentation of a sequence entry')
            ...
            function G (e, t, n) {
              ...
              while (y !== 0) {
                ...
                if ((y !== 63 && y !== 58) || !x(r)) {
                  ...
                  y === 63
                    ? (m && (q(e, f, c, p, d, null), (p = d = v = null)), (g = !0), (m = !0), (i = !0))
                    : m
                      ? ((m = !1), (i = !0))
                      : H(
                        e,
                ...
                if (e.line === s || e.lineIndent > t) {
                  tt(e, t, h, !0, i) && (m ? (d = e.result) : (v = e.result)),
                  m || (q(e, f, c, p, d, v, s, o), (p = d = v = null)),
                  U(e, !0, -1),
                  (y = e.input.charCodeAt(e.position))
                }
                if (e.lineIndent > t && y !== 0) H(e, 'bad indentation of a mapping entry')
                else if (e.lineIndent < t) break
              }
              return (
                m && q(e, f, c, p, d, null),
                g && ((e.tag = u), (e.anchor = a), (e.kind = 'mapping'), (e.result = f)),
                g
              )
            }
            function Y (e) {
                ...
                while (o !== 0 && !x(o)) {
                  o === 33 &&
                        (r
                          ...
                          b.test(i) || H(e, 'named tag handle cannot contain such characters'),
                          (r = !0),
                          (t = e.position + 1))),
                  (o = e.input.charCodeAt(++e.position))
              ...
              return (
                s && !w.test(s) && H(e, 'tag name cannot contain such characters: ' + s),
                n
                  ? (e.tag = s)
                  : a.call(e.tagMap, i)
                    ? (e.tag = e.tagMap[i] + s)
            ...
            function Z (e) {
              ...
              n = e.input.charCodeAt(e.position)
              if (n !== 38) return !1
              e.anchor !== null && H(e, 'duplication of an anchor property'),
              (n = e.input.charCodeAt(++e.position)),
              (t = e.position)
              while (n !== 0 && !x(n) && !T(n)) n = e.input.charCodeAt(++e.position)
              return (
                e.position === t && H(e, 'name of an anchor node must contain at least one character'),
            ...
            function et (e) {
              ...
              while (r !== 0 && !x(r) && !T(r)) r = e.input.charCodeAt(++e.position)
              return (
                e.position === t && H(e, 'name of an alias node must contain at least one character'),
                (n = e.input.slice(t, e.position)),
                e.anchorMap.hasOwnProperty(n) || H(e, 'unidentified alias "' + n + '"'),
            ...
            function tt (e, t, n, r, i) {
              ...
              r &&
                      U(e, !0, -1) &&
                      ((d = !0),
                      e.lineIndent > t ? (p = 1) : e.lineIndent === t ? (p = 0) : e.lineIndent < t && (p = -1))
              if (p === 1) {
                while (Y(e) || Z(e)) {
                  U(e, !0, -1)
                    ? ((d = !0),
                  ...
                  ? (u && (Q(e, w) || G(e, w, b))) || J(e, b)
                    ...
                    : ((o && K(e, b)) || V(e, b) || $(e, b)
                      ...
                      : et(e)
                        ...
                        : X(e, b, f === n) && ((v = !0), e.tag === null && (e.tag = '?')),
                ...
                if (e.tag === '?') {
                  ...
                  a.call(e.typeMap[e.kind || 'fallback'], e.tag)
                    ...
                    y.resolve(e.result)
                      ? ((e.result = y.construct(e.result)),
                      e.anchor !== null && (e.anchorMap[e.anchor] = e.result))
                      : H(e, 'cannot resolve a node with !<' + e.tag + '> explicit tag'))
            ...
            function nt (e) {
              ...
              while ((o = e.input.charCodeAt(e.position)) !== 0) {
                ...
                while (o !== 0 && !x(o)) o = e.input.charCodeAt(++e.position)
                ;(r = e.input.slice(n, e.position)),
                (i = []),
                r.length < 1 && H(e, 'directive name must not be less than one character in length')
                while (o !== 0) {
            ...
            function rt (e, t) {
              ...
              var n = new D(e, t)
              n.input += '\0'
              while (n.input.charCodeAt(n.position) === 32) (n.lineIndent += 1), (n.position += 1)
            ...
            function ot (e, t, n) {
              if (typeof t !== 'function') return it(e, r.extend({ schema: o }, n))
            ...
            var y = /[,\[\]\{\}]/
            var b = /^(?:!|!!|![a-z\-]+!)$/i
            var w = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i
            var O = new Array(256)
            var M = new Array(256)
            for (var _ = 0; _ < 256; _++) (O[_] = L(_) ? 1 : 0), (M[_] = L(_))
            var j = {
              YAML: function (t, n, r) {
                var i, s, o
                t.version !== null && H(t, 'duplication of %YAML directive'),
                r.length !== 1 && H(t, 'YAML directive accepts exactly one argument'),
                (i = /^([0-9]+)\.([0-9]+)$/.exec(r[0])),
                i === null && H(t, 'ill-formed argument of the YAML directive'),
                (s = parseInt(i[1], 10)),
                (o = parseInt(i[2], 10)),
                s !== 1 && H(t, 'unacceptable YAML version of the document'),
                (t.version = r[0]),
                (t.checkLineBreaks = o < 2),
                o !== 1 && o !== 2 && B(t, 'unsupported YAML version of the document')
              },
              TAG: function (t, n, r) {
                var i, s
                r.length !== 2 && H(t, 'TAG directive accepts exactly two arguments'),
                (i = r[0]),
                (s = r[1]),
                b.test(i) || H(t, 'ill-formed tag handle (first argument) of the TAG directive'),
                a.call(t.tagMap, i) && H(t, 'there is a previously declared suffix for "' + i + '" tag handle'),
                w.test(s) || H(t, 'ill-formed tag prefix (second argument) of the TAG directive'),
                (t.tagMap[i] = s)
              },
            }
        ...
        10: [
          function (e, t, n) {
            ...
            function a (e) {
              ...
              (this.compiledTypeMap = u(this.compiledImplicit, this.compiledExplicit))
            }
            var r = e('./common')
            var i = e('./exception')
            var s = e('./type')
        ...
        17: [
          function (e, t, n) {
            ...
            function f (e) {
              ...
              var f = []
              for (t = 0; t < s; t++) {
                t % 4 === 0 && t && (f.push((a >> 16) & 255), f.push((a >> 8) & 255), f.push(a & 255)),
                (a = (a << 6) | o.indexOf(i.charAt(t)))
              }
              return (
                (n = (s % 4) * 6),
                n === 0
                  ? (f.push((a >> 16) & 255), f.push((a >> 8) & 255), f.push(a & 255))
                  : n === 18
            ...
            function l (e) {
              ...
              for (r = 0; r < s; r++) {
                r % 3 === 0 &&
                      r &&
                      ((t += o[(n >> 18) & 63]), (t += o[(n >> 12) & 63]), (t += o[(n >> 6) & 63]), (t += o[n & 63])),
                (n = (n << 8) + e[r])
              }
              return (
                (i = s % 3),
        ...
        27: [
          function (e, t, n) {
            ...
            t.exports = new r('tag:yaml.org,2002:omap', { kind: 'sequence', resolve: o, construct: u })
          },
          { '../type': 16 },
        ],
        28: [
          function (e, t, n) {
            ...
            function o (e) {
              ...
              for (t = 0, n = o.length; t < n; t += 1) (r = o[t]), (i = Object.keys(r)), (s[t] = [i[0], r[i[0]]])
              return s
            }
            var r = e('../type')
            var i = Object.prototype.toString
            t.exports = new r('tag:yaml.org,2002:pairs', { kind: 'sequence', resolve: s, construct: o })
          },
          { '../type': 16 },
        ],
        29: [
        ...
        30: [
          function (e, t, n) {
            ...
            var r = e('../type')
            var i = Object.prototype.hasOwnProperty
            t.exports = new r('tag:yaml.org,2002:set', { kind: 'mapping', resolve: s, construct: o })
          },
          { '../type': 16 },
        ],
        31: [
        ...
        32: [
          function (e, t, n) {
            ...
            function u (e) {
              ...
              return (
                t[9] && ((h = +t[10]), (p = +(t[11] || 0)), (c = (h * 60 + p) * 6e4), t[9] === '-' && (c = -c)),
        ...
        33: [
          function (e, t, n) {
            ;(function (e) {
              ...
              function Rt () {
                ;(this.size = 0), (this.__data__ = { hash: new Lt(), map: new (Nt || Pt)(), string: new Lt() })
              }
              function Ut (e) {
              ...
              function ln (e, t, n, r, i) {
                ...
                rn(
                  t,
                  function (s, o) {
                    if (Wn(s)) i || (i = new Vt()), cn(e, t, o, n, ln, r, i)
                    else {
              ...
              function dn (e, t) {
                if (t) return e.slice()
                var n = e.length
                var r = vt ? vt(n) : new e.constructor(n)
                return e.copy(r), r
              }
              function vn (e) {
              ...
              function yn (e, t, n, r) {
                ...
                while (++s < o) {
                  var u = t[s]
                  var a = r ? r(n[u], e[u], u, n, e) : undefined
              ...
              function bn (e) {
                return hn(function (t, n) {
                  var r = -1
                  var i = n.length
                  var s = i > 1 ? n[i - 1] : undefined
                  var o = i > 2 ? n[2] : undefined
                      ;(s = e.length > 3 && typeof s === 'function' ? (i--, s) : undefined),
                  o && Cn(n[0], n[1], o) && ((s = i < 3 ? undefined : s), (i = 1)),
                  (t = Object(t))
                  while (++r < i) {
                    var u = n[r]
                    u && e(t, u, r, s)
              ...
              function An (e) {
                ...
                var n = (typeof t === 'function' && t.prototype) || it
                return e === n
              }
              function On (e) {
                var t = []
              ...
              var k = '[object DataView]'
              var L = '[object Float32Array]'
              var A = '[object Float64Array]'
              var O = '[object Int8Array]'
              var M = '[object Int16Array]'
              var _ = '[object Int32Array]'
              var D = '[object Uint8Array]'
              var P = '[object Uint8ClampedArray]'
              var H = '[object Uint16Array]'
              var B = '[object Uint32Array]'
              var j = /[\\^$.*+?()[\]{}|]/g
              var F = /^\[object .+?Constructor\]$/
              var I = /^(?:0|[1-9]\d*)$/
              var q = {}
                  ;(q[L] = q[A] = q[O] = q[M] = q[_] = q[D] = q[P] = q[H] = q[B] = !0),
              (q[a] = q[f] = q[C] = q[c] = q[k] = q[h] = q[p] = q[d] = q[m] = q[g] = q[b] = q[E] = q[S] = q[
                x
              ] = q[N] = !1)
              var R = typeof e === 'object' && e && e.Object === Object && e
              var U = typeof self === 'object' && self && self.Object === Object && self
              var z = R || U || Function('return this')()
              var W = typeof n === 'object' && n && !n.nodeType && n
              var X = W && typeof t === 'object' && t && !t.nodeType && t
              var V = X && X.exports === W
              var $ = V && R.process
              var J = (function () {
                try {
              ...
              var K = J && J.isTypedArray
              var nt = Array.prototype
              var rt = Function.prototype
              var it = Object.prototype
              var st = z['__core-js_shared__']
              var ot = rt.toString
              var ut = it.hasOwnProperty
              var at = (function () {
              ...
              var pt = z.Symbol
              var dt = z.Uint8Array
              var vt = ht ? ht.allocUnsafe : undefined
              var mt = et(Object.getPrototypeOf, Object)
              var gt = Object.create
              var yt = it.propertyIsEnumerable
              var bt = nt.splice
              var wt = pt ? pt.toStringTag : undefined
              var Et = (function () {
                try {
              ...
              var St = ht ? ht.isBuffer : undefined
              var xt = Math.max
              var Tt = Date.now
              var Nt = Sn(z, 'Map')
              var Ct = Sn(Object, 'create')
              var kt = (function () {
                function e () {}
                return function (t) {
                  if (!Wn(t)) return {}
              ...
              var pn = Et
                ? function (e, t) {
                  return Et(e, 'toString', { configurable: !0, enumerable: !1, value: Gn(t), writable: !0 })
                }
                : Yn
              var Dn = Pn(pn)
              var jn = on(
...
define('ace/mode/yaml_worker', [], function (e, t) {
  'use strict'
  var n = e('../lib/oop')
  var r = e('../worker/mirror').Mirror
  var i = e('./yaml/yaml-lint').lint
  var s = (t.YamlWorker = function (e) {

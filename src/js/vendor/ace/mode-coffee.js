define('ace/mode/coffee_highlight_rules', [
  ...
  function s () {
    ...
    var f = /\\(?:x[0-9a-fA-F]{2}|u[0-9a-fA-F]{4}|[0-2][0-7]{0,2}|3[0-6][0-7]?|37[0-7]?|[4-7][0-7]?|.)/
    ;(this.$rules = {
      start: [
...
define('ace/mode/coffee', [
  ...
  var i = e('./matching_brace_outdent').MatchingBraceOutdent
  var s = e('./folding/coffee').FoldMode
  var o = e('../range').Range
  var u = e('./text').Mode
  ...
  (function () {
    ...
    (this.getNextLineIndent = function (t, n, r) {
      ...
      var s = this.getTokenizer().getLineTokens(n, t).tokens

...
define('ace/mode/folding/yaml', [
  ...
  (function () {
    ;(this.getFoldWidgetRange = function (e, t, n) {
      ...
      var h = n
      if (u) {
        var p = this.commentBlock(e, n)
        if (p) return p
      } else if (a) {
        var p = this.indentationBlock(e, n)
        if (p) return p
      } else {
        while (++n < l) {
          var i = e.getLine(n)
          ...
          if (d == -1) continue
          if (d <= o && i[o] !== '-') {
            var v = e.getTokenAt(n, 0)
            if (!v || v.type !== 'string') break
          }
          h = n
        }
      }
      if (h > c) {
        var m = e.getLine(h).length
        return new s(c, f, h, m)
      }
    }),
    (this.getFoldWidget = function (e, t, n) {
      var r = e.getLine(n)
...
define('ace/mode/yaml', [
  ...
  var r = e('../lib/oop')
  var i = e('./text').Mode
  var s = e('./yaml_highlight_rules').YamlHighlightRules
  var o = e('./matching_brace_outdent').MatchingBraceOutdent
  var u = e('./folding/yaml').FoldMode

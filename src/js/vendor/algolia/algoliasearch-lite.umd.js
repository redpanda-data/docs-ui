/* eslint-disable */
/*! algoliasearch-lite.umd.js | 4.19.0 | © Algolia, inc. | https://github.com/algolia/algoliasearch-client-javascript */
!(function(e, t) {
    ...
    return {
      ...
      set: function(e, t) {
        return Promise.resolve().then(function() {
          var o = a()
          return (
            (o[JSON.stringify(e)] = { timestamp: new Date().getTime(), value: t }), n().setItem(r, JSON.stringify(o)), t
          )
        })
      },
      delete: function(e) {
  ...
  function b(e) {
    return 'string' == typeof e
      ...
      : { protocol: e.protocol || 'https', url: e.url, accept: e.accept || d.Any }
  }
  var O = 'GET',
    P = 'POST'
  function q(e, t) {
    ...
    var u = [],
      ...
      h = function t(r, a) {
        ...
        var h = {
          ...
          d = function(e) {
            var t = { request: h, response: e, host: l, triesLeft: r.length }
            return u.push(t), t
          },
          p = {
  ...
  var x = function(e) {
      var t = e.appId,
        ...
        })(void 0 !== e.authMode ? e.authMode : m.WithinHeaders, t, e.apiKey),
        a = (function(e) {
          var t = e.hostsCache,
            r = e.logger,
            n = e.requester,
          ...
          r(
            ...
            {},
            {
              headers: r(r(r({}, n.headers()), { 'content-type': 'application/x-www-form-urlencoded' }), e.headers),
      ...
      return function(t, o) {
        return Promise.all(
          t.map(function(t) {
            ...
            return E(e)(t.indexName, { methods: { searchForFacetValues: R } }).searchForFacetValues(
              u,
              i,
              r(r({}, o), s)
            )
    ...
    F = function(e) {
      return function(t, r) {
        return e.transporter.read(
          { method: P, path: f('1/indexes/%s/query', e.indexName), data: { query: t }, cacheable: !0 },
          r
        )
      }
    },
  ...
  function Q(e, t, n) {
    var o,
      a = {
        ...
        hostsCache: i({ caches: [u({ key: ''.concat('4.19.0', '-').concat(e) }), s()] }),
        userAgent: w('4.19.0').add({ segment: 'Browser', version: 'lite' }),
        ...
        {},
        {
          methods: {
            ...
            initIndex: function(e) {
              return function(t) {
                return E(e)(t, { methods: { search: F, searchForFacetValues: R, findAnswers: I } })
              }
            },
          },
        }

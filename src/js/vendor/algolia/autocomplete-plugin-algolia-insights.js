...
!(function(e, t) {
  ...
  function f(e, t) {
    if (e === t) return !0
    if (s(e) || s(t) || 'function' == typeof e || 'function' == typeof t) return e === t
  ...
  function d(e) {
    for (
      var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20, r = [], i = 0;
      i < e.objectIDs.length;
      i += t
    )
      r.push(n(n({}, e), {}, { objectIDs: e.objectIDs.slice(i, i + t) }))
    return r
  }
  function y(e) {
  ...
  function h(e) {
    var t,
      ...
      a,
      u =
        ((t = o((e.version || '').split('.').map(Number), 2)),
        (r = t[0]),
        (a = t[1]),
        r >= 3 || (2 === r && a >= 4) || (1 === r && a >= 10))
    function l(t, n, r) {
      if (u && void 0 !== r) {
        var i = r[0].__autocomplete_algoliaCredentials,
          o = { 'X-Algolia-Application-Id': i.appId, 'X-Algolia-API-Key': i.apiKey }
        e.apply(void 0, [t].concat(c(n), [{ headers: o }]))
      } else e.apply(void 0, [t].concat(c(n)))
    }
    return {
      init: function(t, n) {
      ...
      clickedObjectIDsAfterSearch: function() {
        ...
        t.length > 0 && l('clickedObjectIDsAfterSearch', y(t), t[0].items)
      },
      clickedObjectIDs: function() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n]
        t.length > 0 && l('clickedObjectIDs', y(t), t[0].items)
      },
      ...
      convertedObjectIDsAfterSearch: function() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n]
        t.length > 0 && l('convertedObjectIDsAfterSearch', y(t), t[0].items)
      },
      convertedObjectIDs: function() {
        for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n]
        t.length > 0 && l('convertedObjectIDs', y(t), t[0].items)
      },
      ...
      viewedObjectIDs: function() {
        ...
        t.length > 0 &&
          t
            ...
            .forEach(function(e) {
              var t = e.items
              return l('viewedObjectIDs', [e.payload], t)
            })
      },
  ...
  var I = '2.6.0',
    O = 'https://cdn.jsdelivr.net/npm/search-insights@'.concat(I, '/dist/search-insights.min.js'),
    A = l(function(e) {
      ...
      t({
        insights: i,
        insightsEvents: b({ items: r }).map(function(e) {
          return n({ eventName: 'Items Viewed' }, e)
        }),
        state: o,
      })
    }, 400)
  ...
  ;(e.createAlgoliaInsightsPlugin = function(e) {
    var t = (function(e) {
        return n(
          {
            onItemsChange: function(e) {
              ...
              t.viewedObjectIDs.apply(
                ...
                c(
                  r.map(function(e) {
                    return n(n({}, e), {}, { algoliaSource: w(e.algoliaSource, i.context) })
                  })
                )
              )
            },
    ...
    var g = h(s),
      ...
      d = l(function(e) {
        ...
        if (t.isOpen) {
          ...
          ) || ((v.current = n), n.length > 0 && A({ onItemsChange: i, items: n, insights: g, state: t }))
        }
      }, 0)
    return {
        ...
        function c(e) {
          t({
            algoliaInsightsPlugin: {
              __algoliaSearchParameters: n(n({}, u ? { clickAnalytics: !0 } : {}), e ? { userToken: e } : {}),
              insights: g,
            },
          })
        }
          ...
          r(function(e) {
            ...
            j(t) &&
              o({
                ...
                insights: g,
                item: t,
                insightsEvents: [n({ eventName: 'Item Selected' }, m({ item: t, items: c.getItems().filter(j) }))],
              })
          }),
          i(function(e) {
            var t = e.item,
            ...
            j(t) &&
              a({
                ...
                insights: g,
                item: t,
                insightsEvents: [n({ eventName: 'Item Active' }, m({ item: t, items: r.getItems().filter(j) }))],
              })
          })
      },

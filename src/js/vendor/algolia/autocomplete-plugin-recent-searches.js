 ...
 * Original file: /npm/@algolia/autocomplete-plugin-recent-searches@1.12.1/dist/umd/index.production.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
/*! @algolia/autocomplete-plugin-recent-searches 1.12.1 | MIT License | © Algolia, Inc. and contributors | https://github.com/algolia/autocomplete */
!(function(e, t) {
    ...
    return r(
      ...
      {},
      {
        _highlightResult: {
          label: {
            value: n
              ? t.label.replace(new RegExp(n.replace(/[-/\\^$*+?.()|[\]{}]/g, '\\$&'), 'gi'), function(e) {
          ...
          o(
            ...
            o(
              ...
              o(
                ...
                o(a.ReverseHighlight, { hit: n, attribute: 'label' }),
                n.category &&
                  o(
                    'span',
                    { className: 'aa-ItemContentSubtitle aa-ItemContentSubtitle--inline' },
                    o('span', { className: 'aa-ItemContentSubtitleIcon' }),
                    ' in',
                    ' ',
                    o('span', { className: 'aa-ItemContentSubtitleCategory' }, n.category)
                  )
              )
            )
          ),
          o(
            ...
            o(
              'button',
              {
                ...
                onClick: function(e) {
                  e.preventDefault(), e.stopPropagation(), t(n.id)
                },
              },
              o(
                'svg',
            ...
            o(
              ...
              {
                className: 'aa-ItemActionButton',
                title: 'Fill query with "'.concat(n.label, '"'),
                onClick: function(e) {
              ...
              o(
                ...
                o('path', {
                  d:
                    'M8 17v-7.586l8.293 8.293c0.391 0.391 1.024 0.391 1.414 0s0.391-1.024 0-1.414l-8.293-8.293h7.586c0.552 0 1-0.448 1-1s-0.448-1-1-1h-10c-0.552 0-1 0.448-1 1v10c0 0.552 0.448 1 1 1s1-0.448 1-1z',
                })
              )
            )
          )
    ...
    return function(t) {
      ;(0, t.onSelect)(function(t) {
        var r = t.item,
          n = t.state,
          o = t.source,
          a = o.getItemInputValue({ item: r, state: n })
        if ('querySuggestionsPlugin' === o.sourceId && a) {
          var i = { id: a, label: a, category: r.__autocomplete_qsCategory }
          e.addItem(i)
        }
      })
    }
  ...
  function m(e) {
    ...
    return {
      ...
      getSources: function(e) {
        ...
        return (
          (u.current = c.getAll(t)),
          Promise.resolve(u.current).then(function(e) {
            return 0 === e.length
              ? []
              : [
                  a({
                    source: {
                      ...
                      templates: s({ onRemove: i, onTapAhead: l }),
                    },
                    onRemove: i,
                    onTapAhead: l,
                    state: o,
      ...
      data: r(
        ...
        {},
        {
          getAlgoliaSearchParams: function() {
            ...
            return Array.isArray(u.current)
              ? r(
                  r({}, n),
                  {},
                  {
                    facetFilters: [].concat(
                      o(null !== (e = n.facetFilters) && void 0 !== e ? e : []),
                      o(
                    ...
                    hitsPerPage: Math.max(
                      1,
                      (null !== (t = n.hitsPerPage) && void 0 !== t ? t : 10) - u.current.length
                    ),
                  }
                )
              : n
  ...
  function g(e) {
    ...
    return t
      ? r
          ...
          .slice(0, n)
          .map(function(e) {
            return i({ item: e, query: t })
          })
      : r.slice(0, n).map(function(e) {
          return i({ item: e, query: t })
        })
  }
  function v(e) {
  ...
  ;(e.addHighlightedAttribute = i),
    (e.createLocalStorageRecentSearchesPlugin = function(e) {
      var t = v(e),
        n = t.key,
        a = t.limit,
        i = t.transformSource,
        ...
        })({ key: [c, n].join(':'), limit: a, search: u })
      return r(
        r({}, m({ transformSource: i, storage: f, subscribe: s })),
        {},
        { name: 'aa.localStorageRecentSearchesPlugin', __autocomplete_pluginOptions: e }
      )
    }),
    (e.createRecentSearchesPlugin = m),
    (e.getTemplates = s),
    (e.search = g),

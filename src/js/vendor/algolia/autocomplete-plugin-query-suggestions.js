 ...
 * Original file: /npm/@algolia/autocomplete-plugin-query-suggestions@1.12.1/dist/umd/index.production.js
 *
      ...
      function r(t) {
        return e({
          ...
          return e.map(function(e, r) {
            var n = t.requests[r]
            return { items: e, sourceId: n.sourceId, transformResponse: n.transformResponse }
          })
        })
      }
      return function(e) {
      ...
      return (function(e) {
        ...
        var i = (function(e) {
            var t = e.transporter || {},
              ...
              u = 'x-algolia-api-key'
            return { appId: n[a] || i[a], apiKey: n[u] || i[u] }
          })(t),
          a = i.appId,
          c = i.apiKey
        return t
          .search(
            r.map(function(e) {
              ...
              return b(
                ...
                {
                  params: b(
                    { hitsPerPage: 5, highlightPreTag: '__aa-highlight__', highlightPostTag: '__/aa-highlight__' },
                    t
                  ),
                }
              )
                    ...
                    null === (n = e.hits) || void 0 === n
                      ...
                      : n.map(function(n) {
                          return b(
                            ...
                            {},
                            {
                              __autocomplete_indexName: e.index || r[t].indexName,
                              __autocomplete_queryID: e.queryID,
                              __autocomplete_algoliaCredentials: { appId: a, apiKey: c },
                            }
                          )
                        }),
                }
    ...
    return {
      item: function(e) {
        var r = e.item,
          n = e.createElement,
          o = e.components
        return r.__autocomplete_qsCategory
          ? n(
              'div',
              ...
              n(
                ...
                n(
                  ...
                  n('span', { className: 'aa-ItemContentSubtitleIcon' }),
                  n(
                    'span',
                    null,
                    'in',
                    ' ',
                    n('span', { className: 'aa-ItemContentSubtitleCategory' }, r.__autocomplete_qsCategory)
                  )
                )
              )
            )
          : n(
              ...
              n(
                ...
                n(
                  ...
                  n('div', { className: 'aa-ItemContentTitle' }, n(o.ReverseHighlight, { hit: r, attribute: 'query' }))
                )
              ),
              n(
                'div',
                ...
                n(
                  'button',
                  {
                    ...
                    title: 'Fill query with "'.concat(r.query, '"'),
                    onClick: function(e) {
          ...
          u({
            source: {
              ...
              getItems: function() {
                return _({
                  searchClient: n,
                  queries: [{ indexName: o, query: t, params: a({ state: y }) }],
                  transformResponse: function(e) {
                    var n = e.hits[0]
                    if (!t || !c) return n
                    var o = 0
                    return n.reduce(function(e, t) {
                      ...
                      if (o < l) {
                        ...
                        try {
                          for (y.s(); !(p = y.n()).done; ) {
                            var m = p.value
                            u.push(r({ __autocomplete_qsCategory: m }, t))
                          }
                        } catch (e) {
                          y.e(e)
                        } finally {
